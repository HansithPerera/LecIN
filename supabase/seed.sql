...
VALUES ('loc-001', '101', '1', 'Main Building', ST_GeomFromText('POINT(-73.935242 40.730610)', 4326), '123 Main St, Cityville'),
       ('loc-002', '102', '1', 'Main Building', ST_GeomFromText('POINT(-73.935250 40.730620)', 4326), '123 Main St, Cityville'),
       ('loc-003', '201', '2', 'Science Hall', ST_GeomFromText('POINT(-73.935260 40.730630)', 4326), '456 Science Rd, Cityville'),
       ('loc-004', '202', '2', 'Science Hall', ST_GeomFromText('POINT(-73.935270 40.730640)', 4326), '456 Science Rd, Cityville'),
       ('loc-005', '301', '3', 'History Center', ST_GeomFromText('POINT(-73.935280 40.730650)', 4326), '789 History Ln, Cityville');    
